...
* C++ source files:
  * `include/MRQM/MRQM.hpp` is the main
    C++ header that declares the interface of your library.
  * `src/MRQM.cpp` is the main file that implements this library.
  * `app/MRQM_app.cpp` is an executable that uses the library.
    This can e.g. be used to provide a command line interface for your project.
  * `tests/MRQM_t.cpp` contains the unit tests for the library.
  ...
  * `python/MRQM_python.cpp` is the source file
